...
const FashionProducts = () => {
  const { addToCart } = useCart(); 
       ...
       useEffect(() => {
         const fetchProducts = async () => {
           const response = await fetch('https://shopfront-server.vercel.app/fashion');
  ...
  return (
   <section className="bg-gradient-to-b from-pink-50 to-white py-14">
    <Helmet>
                        <title>Shopfront | Fashion</title>
                      </Helmet>
    <div className="max-w-7xl mx-auto px-4 text-center">
      <h2 className="text-4xl font-extrabold text-gray-800 mb-10">✨ Our Latest Fashion Products</h2>
